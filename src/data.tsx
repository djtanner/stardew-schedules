...
const data: Schedule[] = [
    ...
    },
    {
        ...
        note: "Standard Schedule",
        schedule: [ ["8:00 AM" , "In his bedroom."],
    ...
    },
    {
        ...
        ["1:30 PM" , "Leaves the waiting room and enters the exam room of Harvey's Clinic."],
        ["4:00 PM" , "Leaves the clinic and goes home back to her room."],
        ["8:00 PM" , "Goes to bed."],
    ]
    },
    {
        id: "abigail-spring-mtts",
        note: null ,
        schedule: [ ["9:00 AM" , "Leaves her room to go to the kitchen."],
    ...
    {
        id: "abigail-wednesday",
        note: null ,
        schedule: [ ["10:00 AM" , "Leaves home to go to Museum."],
    ...
    },
    {
        id: "abigail-friday",
        note: null ,
        schedule: [ ["9:00 AM" , "Leaving her room to go to the kitchen."],
...

    {
        ...
        ["8:00 PM" , "In her room, playing video games."],
        ["8:10 PM" , "Goes to bed."],
    ]
    },

    {
        id: "abigail-fall-monday",
        note: null ,
        schedule: [ ["9:00 AM" , "In her room."],
    ...
    },  
    {
        ...
        note: null ,
        schedule: [ ["9:00 AM" , "Leaving her room to go to the kitchen."],
        ["10:30 AM" ,"Leaves her room to stand in Pierre's General Store."],
        ["3:00 PM" , "Goes to The Mountain, standing on the west side of the lake, playing the flute."],
    ...
    {
        id: "abigail-11-25",
        note: "When you have less than 6 hearts with Sebastian, except in Winter" ,
        schedule: [ ["9:00 AM" , "In her bed."],
    ...
    {
        id: "abigail-11-25-option2",
        note: "When you have more than 6 hearts with Sebastian" ,
        schedule: [ ["9:00 AM" , "Leaves her room to go to the kitchen."],
        ["11:00 AM" ,"Leaves home, walks to the Train Platform."],
        ["1:00 PM" , "Waiting in front of the Train Platform."],
        ["2:00 PM" , "Walks to the lake east of the Carpenter's Shop."],
